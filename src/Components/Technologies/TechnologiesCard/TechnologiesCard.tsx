      ...
      <div className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-5 shadow-lg shadow-slate-200/50 transition-all duration-300 hover:-translate-y-2 hover:border-purple-200 hover:shadow-2xl hover:shadow-purple-200/40">
        ...
        <div className="relative">
          ...
          <button
            ...
            disabled={isAdd}
            className={`cursor-pointer w-full rounded-xl bg-linear-to-r from-orange-500 to-pink-500 py-3 text-sm font-semibold text-white shadow-lg shadow-pink-200/50 transition-all duration-300 hover:scale-[1.02] hover:shadow-xl hover:shadow-pink-300/50 active:scale-[0.98] ${
